...
urlpatterns = [
    ...
    path(
        "card/register/", views.CustomerSignupView.as_view(), name="customer_register"
    ),
    path("card/logout/", views.CustomLogoutView.as_view(), name="user_logout"),
    path(
        "card/verify-email/<key>/",
