...
from tasks.models import Author
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/tasks/authors/')
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tasks/author_list.html')
...
from tasks.models import TaskInstance, Task, Category
from django.contrib.auth.models import User  # Required to assign User as a borrower


class LoanedTaskInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/tasks/mytasks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'tasks/taskinstance_list_borrowed_user.html')
    ...
    def test_only_borrowed_tasks_in_list(self):
        ...
        for taskitem in response.context['taskinstance_list']:
            ...
            self.assertEqual(taskitem.status, 'o')
...
class RenewTaskInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'tasks/task_renew_librarian.html')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, '/accounts/login/?next=/tasks/author/create/')
    ...
    def test_uses_correct_template(self):
        ...
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tasks/author_form.html')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url.startswith('/tasks/author/'))
