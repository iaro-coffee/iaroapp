...
class Command(BaseCommand):
    help = 'Fetches popular times data for a given place. ' \
    ...
    def add_arguments(self, parser):
        parser.add_argument('place_name', type=str, help='Name of the place to fetch data for, including the full address')
